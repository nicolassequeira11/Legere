      ...
      <div className="d-flex flex-column-reverse flex-md-row justify-content-around container-lg my-5">
        <div className="col-12 col-md-6 col-lg-8 pe-md-5 mt-5 mt-md-0 py-2">
          ...
          <div className="details-info-container">
            <p className="details-info-item">Número de páginas: {book.volumeInfo.pageCount}</p>
            <p className="details-info-item">Idioma: {book.volumeInfo.language}</p>
            <p className="details-info-item">Editorial: {book.volumeInfo.publisher}</p>
            <p className="details-info-item">ISBN: {book.volumeInfo.industryIdentifiers[1].identifier}</p>
          </div>
          <div>
        ...
        <div className="details-img-container col-12 col-md-4 col-lg-3">
          <img src={book.volumeInfo.imageLinks.thumbnail} className="details-img col-10"/>
